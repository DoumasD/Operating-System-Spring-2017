...
//////////////////////////////////////////////////////////// Check if you are able to open these files
	...
	if(fd1 == -1) //error opening file
		{
		printf("sorry, I couldn't open destination1 file\n");
		perror("open"); 
		}
	else
		{
		printf("Destination1 File is able to Open\n");
		}

	if(fd2 == -1) //error opening file
		{
		printf("sorry, I couldn't open destination2 file\n");
		perror("open"); 
		}
	else
		{
		printf("Destination2 File is able to Open \n");
		}
...
lseek(fd,0,SEEK_SET);  /// Reset the file descripter fd to the begininng of the source file
